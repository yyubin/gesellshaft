    ...
    return (
        <Layout>
            <div className="flex w-full min-h-screen bg-gray-900 text-white">
                <aside className="w-1/5 p-4 border-r border-gray-700 bg-gray-800 overflow-y-auto">
                    ...
                    <div className="space-y-2">
                        {prisoners.map(prisoner => (
                            ...
                            >
                                ...
                                />
                                <span className="font-semibold text-xl">{prisoner.name}</span>
                            </div>
                        ))}
                    </div>
                </aside>
                                ...
                                <div className="flex overflow-x-auto space-x-4 pb-4 border-b border-gray-700 mb-6">
                                    {personas.length > 0 ? (
                                        personas.map(persona => (
                                            <div
                                                key={persona.id}
                                                className={`relative flex-shrink-0 w-24 h-32 rounded-lg overflow-hidden shadow-md cursor-pointer
